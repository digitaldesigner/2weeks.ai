...
echo "
		<li class='lesson' id='lesson-".$lessonNumber."'>
			<a href='#' draggable='false' class='expander'>&#215;</a>
			<div class='header'>
				<h5>".$title."</h5>
			</div>
			<div class='contents overflow fetchmd' data-src='content/".$filename."'></div>
			<label>
...
";
	...
	<div class="prompt" id="daily">
		...
		<div class='contents' id="daily-file"><!-- Daily prompts --></div>
	</div>
